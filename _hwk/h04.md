...
<li markdown="1"> prior to the call to the `swap` function </li>
<li markdown="1"> in the body of the `swap` function </li>
<li markdown="1"> following the call to the `swap` function </li>
