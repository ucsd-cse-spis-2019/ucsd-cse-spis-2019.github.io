...
``` 
[spis15t7@ieng6-240]:~:111$ pip install --user Flask
Collecting Flask
...
Successfully installed Flask Jinja2 MarkupSafe Werkzeug itsdangerous
[spis15t7@ieng6-240]:~:112$ 
```
...
If instead, you are using a terminal program to remotely access the ieng6-240.ucsd.edu server via Windows or Mac, then to bring up a server on the same machine, you'll probably need to use vncgnome to bring up a Gnome session.   You can then click to bring up a browser running on ieng6-240.ucsd.edu.  (Learn how).

Once you have your browser up, enter the web address http://localhost:5000 or http://127.0.0.1:5000 (Note: if you 
...
localhost:5000 on Firefox via vncgnome
